            ...
            <div className="carousel-item position-relative active" style={{height: 430}}>
              ...
              <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div className="p-3" style={{maxWidth: 700}}>
                  ...
                  <p className="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" >
                    Shop Now
                    </p>
                </div>
              </div>
            ...
            <div className="carousel-item position-relative" style={{height: 430}}>
              ...
              <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div className="p-3" style={{maxWidth: 700}}>
                  ...
                  <p className="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" >Shop Now</p>
                </div>
              </div>
            </div>
            <div className="carousel-item position-relative" style={{height: 430}}>
          ...
          <div className="product-item bg-light mb-4">
            <div className="product-img position-relative overflow-hidden">
              ...
              <div className="product-action">
                <Link className="btn btn-outline-dark btn-square" onClick={()=> addTocart(item)}><i className="fa fa-shopping-cart" /></Link>
